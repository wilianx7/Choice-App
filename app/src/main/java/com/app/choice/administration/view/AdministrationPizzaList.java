...
public class AdministrationPizzaList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administration_pizza_list);

        // Configurar Toolbar.
        toolbar = findViewById(R.id.adm_pizza_list_toolbar);
        toolbar.setTitle("Pizzas");
        setSupportActionBar(toolbar);

        listView = findViewById(R.id.pizza_list_view);
        floatingActionButton = findViewById(R.id.adm_floatingActionButton);
        ...
        adapter = new CommercialPizzaListAdapter(AdministrationPizzaList.this, pizzasArray);
        listView.setAdapter(adapter);
        onSwipeTouchListener = new OnSwipeTouchListener(AdministrationPizzaList.this, listView, adapter);
    ...
    private void openHelpDialog() {
        AlertDialog.Builder helpDialog = new AlertDialog.Builder(AdministrationPizzaList.this, R.style.MyAlertDialogTheme);
    ...
    private void openConfirmDialog() {
        AlertDialog.Builder confirmDialog = new AlertDialog.Builder(AdministrationPizzaList.this, R.style.MyAlertDialogTheme);
        ...
        confirmDialog.setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ArrayList<CommercialPizzaModel> acceptedPizzas = new ArrayList<>();

                for (CommercialPizzaModel model : pizzasArray) {
                    if (model.isAccepted()) {
                        acceptedPizzas.add(model);
                    }
                }

                Intent returnIntent = new Intent();
                returnIntent.putExtra("result", acceptedPizzas);
    ...
    private void openPizzaInformationsDialog(int position) {
        AlertDialog.Builder informationsDialog = new AlertDialog.Builder(AdministrationPizzaList.this, R.style.MyAlertDialogTheme);
        informationsDialog.setTitle(pizzasArray.get(position).getFlavor());
        informationsDialog.setCancelable(true);

        ImageView pizzaIcon = new ImageView(AdministrationPizzaList.this);
