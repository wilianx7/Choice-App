...
import com.app.choice.administration.view.Registers.PizzaCasterRegister;
...
public class PizzaCastersFragment extends Fragment {
    ...
    private void setButtonActions() {
        pizzaCasterButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /** Cadastro de Rodízios **/
                Intent intent = new Intent(getActivity(), PizzaCasterRegister.class);
